      ...
      <section className="bg-brand-navy py-16 sm:py-20">
        <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-brand-slate-300 text-lg max-w-2xl mx-auto">
            Have a question? Want to check if a product is available? Reach out to us directly.
          </p>
        </div>
      </section>
        ...
        <div className="container-wide mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="reveal">
              <h2 className="heading-main text-2xl sm:text-3xl font-bold mb-6">
                Contact Information
              </h2>
              ...
              <div className="space-y-5 mb-10">
                <div className="flex items-start gap-4 bg-white rounded-2xl p-5 shadow-card">
                  ...
                  <div>
                    <h3 className="font-heading font-semibold text-brand-navy mb-1">Location</h3>
                    <p className="text-brand-slate-500 text-sm">{SITE.LOCATION}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-white rounded-2xl p-5 shadow-card">
                  ...
                  <div>
                    <h3 className="font-heading font-semibold text-brand-navy mb-1">Phone</h3>
                    <p className="text-brand-slate-500 text-sm">{SITE.PHONE}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-white rounded-2xl p-5 shadow-card">
                  ...
                  <div>
                    <h3 className="font-heading font-semibold text-brand-navy mb-1">WhatsApp</h3>
                    <p className="text-brand-slate-500 text-sm">{SITE.WHATSAPP}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-white rounded-2xl p-5 shadow-card">
                  ...
                  <div>
                    <h3 className="font-heading font-semibold text-brand-navy mb-1">Email</h3>
                    <p className="text-brand-slate-500 text-sm">{SITE.EMAIL}</p>
                  </div>
                </div>
              </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 sm:p-8 shadow-card">
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="label-field">Product / Category</label>
                      <input
                        type="text"
                        value={formData.product}
                        onChange={(e) => setFormData({ ...formData, product: e.target.value })}
                        className="input-field"
                        placeholder="e.g. Football, Swimming Goggles, Handbag"
                      />
                    </div>
                    <div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            {requestSubmitted ? (
              <div className="bg-brand-cream rounded-2xl p-8 text-center reveal">
                ...
                <p className="text-brand-slate-500 mb-4">
                  Thank you! We&apos;ll get back to you regarding your request.
                </p>
                <button
                  onClick={() => { setRequestSubmitted(false); setRequestData({ name: "", phone: "", product: "", category: "", size: "", budget: "", message: "" }); }}
                  className="btn-primary"
                >
              ...
              <form onSubmit={handleRequestSubmit} className="bg-brand-cream rounded-2xl p-6 sm:p-8 reveal">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="label-field">Product You&apos;re Looking For *</label>
                    <input
                      type="text"
                      required
                      value={requestData.product}
                      onChange={(e) => setRequestData({ ...requestData, product: e.target.value })}
                      className="input-field"
                      placeholder="e.g. Nike Football, Swimming Goggles"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="label-field">Preferred Size</label>
                    <input
                      type="text"
                      value={requestData.size}
                      onChange={(e) => setRequestData({ ...requestData, size: e.target.value })}
                      className="input-field"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="input-field"
                      placeholder="e.g. Under KSh 2,000"
                    />
                  </div>
