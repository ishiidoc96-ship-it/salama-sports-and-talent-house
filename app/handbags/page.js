...
export const metadata = {
  ...
  description: `Discover Ex-UK handbags, tote bags and fashion accessories at ${SITE.COMPANY_NAME} in Kilifi Town.`,
};
    ...
    <>
      ...
      <section className="section-padding bg-brand-cream">
        <div className="container-wide mx-auto">
          <div className="bg-white rounded-2xl p-6 shadow-card mb-10 reveal">
            <p className="text-brand-slate-600 text-center">
              <strong>Fresh Finds.</strong> <strong>New Stock.</strong> <strong>Limited Finds.</strong> Our Ex-UK bag selection changes regularly — ask about availability for the latest items.
            </p>
          </div>
      ...
      <section className="py-12 bg-pink-500">
        <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href={`https://wa.me/${SITE.WHATSAPP.replace(/[^0-9]/g, "")}?text=${encodeURIComponent("Hello! I'm interested in your handbags and tote bags. What's currently available?")}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-pink-500 font-bold rounded-xl hover:bg-brand-cream transition-all duration-300 shadow-lg"
          >
