...
export const metadata = {
  title: "Kids",
  description: `Discover hard Ex-UK children's toys, games and fun products at ${SITE.COMPANY_NAME} in Kilifi Town.`,
};
    ...
    <>
      ...
      <section className="py-12 bg-brand-orange">
        <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href={`https://wa.me/${SITE.WHATSAPP.replace(/[^0-9]/g, "")}?text=${encodeURIComponent("Hello! I'm interested in your children's toys and games. What's currently available?")}`}
            target="_blank"
